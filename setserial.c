...
fprintf(stderr, "\t* port\t\tset the I/O port\n");
	...
	fprintf(stderr, "\t^ low_latency\tThis support is deprecated starting from 3.12 kernel\n");
	fprintf(stderr, "\t\t\t\tEnabling this flag needs a custom implementation in driver\n");
